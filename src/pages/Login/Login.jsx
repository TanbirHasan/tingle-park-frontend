		...
		<div>
			<div className="w-full max-w-md mx-auto my-20 p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
				...
				<form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
					...
					<div className="space-y-1 text-sm">
						...
						<input
							...
							className="w-full px-4 py-3 rounded-md border border-gray-700 bg-gray-900 text-gray-100 focus:border-yellow-400"
						/>
				...
				<p className="text-xs text-center sm:px-6 text-gray-400">
					...
					<a rel="noopener noreferrer" href="#" className="underline text-gray-100">
						Sign up
					</a>
				</p>
			</div>
