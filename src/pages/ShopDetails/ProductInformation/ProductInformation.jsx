...
const ProductInformation = () => {
	return (
		<div className="mt-10">
			...
			<div className="grid grid-cols-2 gap-x-10 gap-y-4 mt-10 text-lg">
				<div className="mt-3 text-[#6c757d] border-b border-gray-300">
					<h1>Sit erat duo lorem duo ea consetetur, et eirmod takimata.</h1>
				</div>
				<div className="mt-3 text-[#6c757d] border-b border-gray-300">
					<h1>Sit erat duo lorem duo ea consetetur, et eirmod takimata.</h1>
				</div>
